...
class ExerciseTest(tf.test.TestCase):
    ...
    def testLayer4(self):
        ...
        self.assertEqual(layer4.output_shape, (None, 170528))

    def testLayer5(self):
        model = self.exercise.our_model
        layer5 = model.layers[5]
        self.assertEqual(layer5.input_shape, (None, 170528))
        self.assertEqual(layer5.output_shape, (None, 512))

    def testLayer6(self):
        model = self.exercise.our_model
        layer6 = model.layers[6]
        self.assertEqual(layer6.input_shape, (None, 512))
        self.assertEqual(layer6.output_shape, (None, 1))
