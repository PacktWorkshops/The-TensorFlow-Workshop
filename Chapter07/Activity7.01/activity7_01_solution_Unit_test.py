...
class ActivityTest(tf.test.TestCase):

    def setUp(self):
        import activity7_01_solution
        super(ActivityTest, self).setUp()
        self.exercise = activity7_01_solution

    def testModelInput(self):
        self.assertEqual(self.exercise.model.input_shape, (None, 32, 32, 3))
        self.assertEqual(self.exercise.model.output_shape, (None, 100))
    ...
    def testLayer8(self):
        ...
        self.assertEqual(layer.input_shape, (None, 1024))
        self.assertEqual(layer.output_shape, (None, 100))
